...
RAH SOLiDModule::pt2rah(pcl::PointXYZI & point, float gap_angle, float gap_range, float gap_height)
{
    RAH rah;
...
void SOLiDModule::makeAndSaveSolid(pcl::PointCloud<pcl::PointXYZI> &scan_down) 
{
...
std::tuple<int, int, float> SOLiDModule::detectLoopClosureID( void )
{
    int loop_id { -1 };
    if(solids_.empty() && solids_mat_.empty())
    {
        return std::make_tuple(-1, -1, 0.0f);
    }
    ...
    return std::make_tuple(solids_.size()-1, loop_id, yaw_diff_rad);
}

//////////////////////////////////////////////////////////////////////////

////////////////////////////// point module //////////////////////////////
void SOLiDModule::remove_far_points(pcl::PointCloud<pcl::PointXYZI> & scan_raw, pcl::PointCloud<pcl::PointXYZI>::Ptr scan_out)
{
...
void SOLiDModule::remove_closest_points(pcl::PointCloud<pcl::PointXYZI> & scan_raw, pcl::PointCloud<pcl::PointXYZI>::Ptr scan_out)
{
...
void SOLiDModule::down_sampling(pcl::PointCloud<pcl::PointXYZI> & scan_raw, pcl::PointCloud<pcl::PointXYZI>::Ptr scan_down)
{
    pcl::PointCloud<pcl::PointXYZI> Data_for_Voxel;
    pcl::VoxelGrid<pcl::PointXYZI> downSizeFilterSolid;
