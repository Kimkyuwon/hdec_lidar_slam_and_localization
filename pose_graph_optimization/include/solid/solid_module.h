...
public:
    ...
    Eigen::VectorXd makeSolid(pcl::PointCloud<pcl::PointXYZI> scan_down);
    ...
    RAH pt2rah(pcl::PointXYZI & scan_down, float gap_angle, float gap_range, float gap_elevation);
    ...
    void makeAndSaveSolid(pcl::PointCloud<pcl::PointXYZI> &scan_down);
    
    std::tuple<int, int, float> detectLoopClosureID(void);

    ////// point module //////
    void remove_far_points(pcl::PointCloud<pcl::PointXYZI> & scan_raw, pcl::PointCloud<pcl::PointXYZI>::Ptr scan_out);
    void remove_closest_points(pcl::PointCloud<pcl::PointXYZI> & scan_raw, pcl::PointCloud<pcl::PointXYZI>::Ptr scan_out);
    void down_sampling(pcl::PointCloud<pcl::PointXYZI> & scan_raw, pcl::PointCloud<pcl::PointXYZI>::Ptr scan_down);
